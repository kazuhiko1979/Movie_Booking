...
movies = {"Horror":["Hereditary", "A Quite Place", "The Conjuring 2", "The Grudge",
                    "Anabelle Comes Home"],
          "Action":["Avengers Eng Game", "John Wick Chapter 3", "Aquaman", "Black Panther",
                    "Mission Impossible"],
          "Drama":["Joker", "Spotlight", "Little Women", "The IrishMan",
                   "A star is born"],
          "Comedy":["Step Brothers", "BookSmart", "Horrible Bosses", "The Other Guys",
                    "SuperBad"],
          "Sci-Fi":["Star Wars", "Annihilation", "Arraival", "Interstellar",
                    "The Martian"],
...
class Application(tk.Tk):
    ...
    def createWidgets(self):
        headingLabel = tk.Label(self, text="Cineman Seat Bookings",
                                font="Aries 12 bold")
    ...
    def seatSelection(self):
        ...
        for i in range(4):
            temp = []
            for j in range(15):
                but = tk.Button(seats, bd=2, bg="Green",
    ...
    def bookseat(self):
        for i in seatSelected:
            ...
            seatList[i[0]][i[1]]['activebackground'] = 'forestGreen'
